...
- [x] User can **compose and post a new tweet**
  - [x] User can click a âComposeâ icon in the Action Bar on the top right
...
<img src='https://i.imgur.com/2Iwc59l.gifv' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
I didn't know that that database version would affect the persistence of the application.
